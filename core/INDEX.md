...
| [EQUIPMENT_REGISTRY_EXPANSION_2026-08-03.md](EQUIPMENT_REGISTRY_EXPANSION_2026-08-03.md) | **Why the registry is 67 machines, not 52** — the 15 new ids found in the vendor pack's own clips, a real kCanonicalMachines-vs-registry drift bug fixed along the way, and the 7 exercises deliberately left open. Read before editing `scripts/catalog/build_registry.py` or `kCanonicalMachines`. CSV twin beside it |
