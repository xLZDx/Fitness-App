...
| [CLIP_LICENCE_AUDIT_2026-08-03.md](CLIP_LICENCE_AUDIT_2026-08-03.md) | **Where every exercise clip comes from and whether we may host it.** Read before touching `exercises_vendor.json` or the video buckets. (It said `exercises.json`, which was deleted 2026-08-04 along with its Russian overlay — see `LEGACY_CATALOG_REMOVED_2026-08-04.md`.) CSV twin beside it; per-exercise verdicts in `subset_verdicts.csv` |
...
| [VENDOR_EQUIPMENT_LINK_2026-08-03.md](VENDOR_EQUIPMENT_LINK_2026-08-03.md) | **Which vendor exercises are linked to which machine, and why.** Read before touching `equipmentId` on vendor entries or the machine detail page. CSV twin beside it; open items in `vendor_equipment_needs_review.csv`; the honest per-exercise breakdown of what the still-unlinked ones actually show is `EQUIPMENT_GAP_ITEMS_2026-08-03.csv` |
| [EQUIPMENT_REGISTRY_EXPANSION_2026-08-03.md](EQUIPMENT_REGISTRY_EXPANSION_2026-08-03.md) | **Why the registry is 69 machines, not 52** — the 17 new ids found in the vendor pack's own clips, a real kCanonicalMachines-vs-registry drift bug fixed along the way. Read before editing `scripts/catalog/build_registry.py` or `kCanonicalMachines`. CSV twin beside it |
| [LEGACY_CATALOG_REMOVED_2026-08-04.md](LEGACY_CATALOG_REMOVED_2026-08-04.md) | **Why there is only one exercise catalog** — what `exercises.json` was, why removing it was safe, the 4 machine pages it left empty, and the Russian-overlay bug its removal exposed. Read before wondering where `exercises.json` or `includeLegacy` went. CSV twin beside it |
