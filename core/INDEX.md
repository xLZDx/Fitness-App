...
| [PRODUCTION_MANIFEST.md](PRODUCTION_MANIFEST.md) | **What is actually deployed right now** — function source generations, Firestore ruleset id, Hosting version, App Check enforcement modes. Generated by `scripts/dev/production_manifest.py`; re-run it rather than editing. CSV twin beside it |
