...
| **P2f** Production manifest | **DONE** — generated by `scripts/dev/production_manifest.py`, 21 rows, 0 unavailable; confirms App Check still UNENFORCED on all three services | this commit |
